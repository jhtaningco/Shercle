...
interface CswdOfficialsTableProps {
  officials: CswdOfficial[];
  loading?: boolean;
  onEdit: (official: CswdOfficial) => void;
  onToggleStatus: (official: CswdOfficial) => void;
  onDelete: (official: CswdOfficial) => void;
}

function getFullName(official: CswdOfficial): string {
...
export function CswdOfficialsTable({
  officials,
  loading = false,
  onEdit,
  onToggleStatus,
  onDelete
}: CswdOfficialsTableProps) {
    ...
    return (
      <div className='flex flex-col items-center justify-center py-16 text-center'>
        ...
        <p className='text-muted-foreground text-xs'>
          Click "Add Official" to create the first CSWD official.
        </p>
      </div>
    );
  }
