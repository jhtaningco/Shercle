...
interface CdrrmoOfficialsTableProps {
  officials: CdrrmoOfficial[];
  loading?: boolean;
  onEdit: (official: CdrrmoOfficial) => void;
  onToggleStatus: (official: CdrrmoOfficial) => void;
  onDelete: (official: CdrrmoOfficial) => void;
}

function getFullName(official: CdrrmoOfficial): string {
...
export function CdrrmoOfficialsTable({
  officials,
  loading = false,
  onEdit,
  onToggleStatus,
  onDelete
}: CdrrmoOfficialsTableProps) {
    ...
    return (
      <div className='flex flex-col items-center justify-center py-16 text-center'>
        ...
        <p className='text-muted-foreground text-xs'>
          Click "Add Official" to create the first CDRRMO official.
        </p>
      </div>
    );
  }
